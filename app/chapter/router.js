...
const { handlerGetAllChaptersByCourseID, handlerGetChapterAndArticle, handlerGetChapterById, handlerPostChapter, handlerPutChapter, handlerDeleteChapter } = require('./handler');
...
//API get chapters by id: GET /course/:id_course/chapter/:id_chapter
router.get("/:id_course/chapters/:id_chapter", authenticationToken, handlerGetChapterById);
