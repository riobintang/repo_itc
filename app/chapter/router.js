...
router.get("/:id_course/chapter/article", authenticationToken, handlerGetChapterAndArticle);
...
router.put("/:id_course/chapter/:id_chapter", authenticationToken, loginAdmin, handlerPutChapter);
//API delete chapter from specific course: DELETE /course/:id_course/chapter/:id_chapter
router.delete("/:id_course/chapter/:id_chapter", authenticationToken, loginAdmin, handlerDeleteChapter);
